# genpark-pull-request-semantic-risk-blast-radius-scorer-skill
...
**genpark-pull-request-semantic-risk-blast-radius-scorer-skill** is a deterministic, zero-dependency Python skill engineered for autonomous software engineering agents, codebase refactoring, and AST intelligence pipelines.

> **Executive Capability**: Pull request semantic risk blast-radius & breaking change scorer (Qodo)
...
result = client.score_pull_request_risk()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-pull-request-semantic-risk-blast-radius-scorer-skill": {
      "command": "python",
      "args": ["/path/to/genpark-pull-request-semantic-risk-blast-radius-scorer-skill/mcp_server.py"]
    }
  }
}
```
